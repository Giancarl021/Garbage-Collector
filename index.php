        ...
        <?php
            ...
            if (sizeof($q) == 0) {
                ...
                foreach ($q as $card) {
                    ...
                    if (!count($card["answers"])) echo "<div class='question-card answer'><h1 class='question-title answer' style='text-align: center'>Não há respostas para esta pergunta ainda</h1></div>";
                    else {
...
//                    echo "<pre>" . print_r($ans, true) . "</pre>";
            ...
            if (!is_null($user)) {
                echo "<div id=\"add-question\" onclick=\"initModal('Fazer pergunta', false)\">" .
